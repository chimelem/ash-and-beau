...
import {ProductGallery, ProductSwimlane} from '~/components/list';
import Container from '~/components/container';
import {IconCheck, IconClose} from '~/components/icon';
import {AddToCartButton, CustomButton} from '~/components/buttons';
...
export default function Product() {
  ...
  return (
    <Container>
      <Section className="mt-20 px-0 mt-20 md:px-8 lg:px-12">
        <div className="">
          <Link
            to="/collections/all"
        ...
        <div className="grid items-start gap-2 sm:gap-4 grid-cols-1 sm:grid-cols-2">
          <div className="p-2 w-full">
            <ProductGallery media={media.nodes} className="w-full" />
          </div>
          <div className="sticky md:-mb-nav md:top-nav md:-translate-y-nav md:h-screen md:pt-nav hiddenScroll md:overflow-y-scroll">
            <section className="flex flex-col w-full gap-2 p-6 md:px-0">
              <div className="grid gap-2">
                {vendor && (
                  <div className="flex flex-row items-center gap-4">
                    <img src="/images/check.svg" className="w-auto h-8" />
                    <Text className={'font-medium color-green font-base'}>
                      {vendor}
                    </Text>
                  </div>
                )}
                <div className="flex flex-row items-center justify-between">
                  <Heading
                    as="h1"
                    className="whitespace-normal text-4xl font-Libre"
                  >
                    {title}
                  </Heading>
                  <div>
...
export function ProductForm() {
  const {product, cart, analytics, storeDomain} = useLoaderData();
...
function ProductDetail({title, content, learnMore, stayOpen = false}) {
  return (
    <Disclosure
      key={title}
      as="div"
      defaultOpen={stayOpen}
      className="grid w-full gap-2 bg-gray-100 p-5 rounded-lg"
    >
      {({open}) => (
        <>
